...
+ (NSString *)csvHeader
{
    return @"timestamp,timeIntervalSince1970,createDate,createDateSince1970,activityTimestamp,stationary,walking,running,automotive,cycling,unknown,confidence";
}
