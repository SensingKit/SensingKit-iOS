...
@protocol KKiBeaconSensingDelegate <NSObject>
...
@interface KKiBeaconSensing : NSObject<CBPeripheralManagerDelegate, CLLocationManagerDelegate>

@property (weak, nonatomic) id <KKiBeaconSensingDelegate> delegate;
